...
namespace TownplanningEfApp.ModelB
{
    ...
    {
        TownPlanningContextB _dbcontext;
        public PersonRepositoryTracking()
        {
            _dbcontext = new TownPlanningContextB();
            
        }
        public PersonRepositoryTracking(TownPlanningContextB dbcontext)
        {
        ...
        {           
            ...
            /**
                ...
                * has a PersonId property, then EfCore will treat the PersonId as ForeignKey
                * --IMPORTANT--
                * If a new Person is added to the table without an AadhaarCard then 
                * the the new Person is added without an Aadhar.
                * An Aadhaar can be added later and assigned to the Person
                */
        }
        ...
        public void AddAadhaar(AadhaarCard card)
        {
