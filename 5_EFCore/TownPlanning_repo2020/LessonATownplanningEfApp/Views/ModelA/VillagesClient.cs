...
namespace TownplanningEfApp.Views.ModelA
{
    public class VillagesClient
    {
        public static void DisplayAllVillages()
        {
            ...
            foreach(Village v in villagelist)
            {
                ...
                if(v.Residents !=null)
                {
                    ...
                    {
                        System.Console.WriteLine($"\t{p.PersonId}, {p.Name}, {p.DateOfBirth}, {p.AadhaarCard.AadhaarId}");
                        AadhaarCard card=p.AadhaarCard;
                        if(card!=null)
                            System.Console.WriteLine($"\tNo:{card.AadhaarId} IssuedOn:{card.DateOfIssue} ValidTill:{card.ValidTill}");
                        else
        ...
        public static void Demo_AddVillagePersonAndCard()
        {
