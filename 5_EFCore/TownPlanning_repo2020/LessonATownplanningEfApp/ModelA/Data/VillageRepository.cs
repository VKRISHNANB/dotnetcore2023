...
namespace TownplanningEfApp.ModelA
{
    ...
    {
        TownPlanningContextA _dbcontext = null;
        ...
        public  List<Village> GetVillages()
        {
            List<Village> villages;
             villages= _dbcontext.Villages.Include(r => r.Residents).ThenInclude(c => c.AadhaarCard).ToList();              
            return villages;
        }
        #region  Inserts
        ...
        */       
        ...
        public void FindByNameUsingLike_NotParameterized()
        {
            ...
            /**
             * NO Parameter is created in SQl Query if the search value is provided 
            ...
            /**
                Parameter is created in the SQL Query 
                if search value is provided as a variable
                var name="Sam";
                Where(s=> s.Name==name)
            */
        ...
        **/
        public static void AttachVillageNotTracked(Village f)
        {
            using (TownPlanningContextA _dbcontext=new TownPlanningContextA())
            {
                ...
                */
                /** IMPORTANT            
                * Attaching an entity that is currently being Tracked, and 
                * if the state of the entity is in Added or Modified state, then 
                * the state of the entity will change to Unchanged. And
                * calling SaveChanges() on this entity will not save the entity
                * */
            }
        }
        /** 
