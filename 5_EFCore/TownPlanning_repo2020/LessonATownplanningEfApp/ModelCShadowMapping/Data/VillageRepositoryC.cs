...
namespace TownplanningEfApp.ModelC
{
    ...
    {
        TownPlanningContextC _dbcontext = null;
        public VillageRepository()
        {           
            _dbcontext = new TownPlanningContextC();           
        }
        public VillageRepository(bool flagensureDeletedCreated)
        {
            _dbcontext = new TownPlanningContextC(flagensureDeletedCreated);
        }
