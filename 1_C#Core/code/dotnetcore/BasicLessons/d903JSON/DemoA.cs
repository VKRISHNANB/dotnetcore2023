...
namespace BasicLessons.JsonReaderSample
{
    class DemoA
    {
        ...
        public static void TaskA()
        {
            ...
            //string filename1=@"C:\classroom\world_universities_and_domains.json";
            string filename1=@"C:\temp\world_universities_and_domains.json";

            string outputMessage = SyncFileExample(filename1);
        ...
        public static  async Task TaskB()
        {
            ...
            string outputMessage = SyncFileExample(filename1);
            Console.WriteLine("Reading JSON from file, sync: " + outputMessage);
            // filename1=@"http://universities.hipolabs.com/search?country=United%20States";
            outputMessage = await AsyncWebExample(filename1);
            Console.WriteLine("Reading JSON from web, async: " + outputMessage);
            filename1=@"http://universities.hipolabs.com/search?";
            // outputMessage = await AsyncWebExample(filename1, worldWide: true);
            // Console.WriteLine("Reading JSON from web, async: " + outputMessage);
        }
...
/**
'w' is invalid after a value. Expected either ',', '}', or ']'. LineNumber: 0 | BytePositionInLine: 1014.
   at System.Text.Json.ThrowHelper.ThrowJsonReaderException(Utf8JsonReader& json, ExceptionResource resource, Byte nextByte, ReadOnlySpan`1 bytes)
   at System.Text.Json.Utf8JsonReader.ConsumeNextToken(Byte marker)
   at System.Text.Json.Utf8JsonReader.ConsumeNextTokenOrRollback(Byte marker)
   at System.Text.Json.Utf8JsonReader.ReadSingleSegment()
   at System.Text.Json.Utf8JsonReader.Read()
   at BasicLessons.JsonReaderSample.DemoA.PartialCountUniversityOf(ReadOnlySpan`1 dataUtf8, Boolean isFinalBlock, Boolean& foundName, JsonReaderState state) in C:\Users\venkatakrishnanb\OneDrive\classroom\2dotnet\dotnetCore\C#Core\code\dotnetcore\BasicLessons\d903JSON\DemoA.cs:line 171
   at BasicLessons.JsonReaderSample.DemoA.ReadJsonFromStreamUsingSpan(Stream stream) in C:\Users\venkatakrishnanb\OneDrive\classroom\2dotnet\dotnetCore\C#Core\code\dotnetcore\BasicLessons\d903JSON\DemoA.cs:line 141
   at BasicLessons.JsonReaderSample.DemoA.AsyncWebExample(String url, Boolean worldWide) in C:\Users\venkatakrishnanb\OneDrive\classroom\2dotnet\dotnetCore\C#Core\code\dotnetcore\BasicLessons\d903JSON\DemoA.cs:line 102
   at BasicLessons.JsonReaderSample.DemoA.TaskB() in C:\Users\venkatakrishnanb\OneDrive\classroom\2dotnet\dotnetCore\C#Core\code\dotnetcore\BasicLessons\d903JSON\DemoA.cs:line 33
   at BasicLessons.Program.Main(String[] args) in C:\Users\venkatakrishnanb\OneDrive\classroom\2dotnet\dotnetCore\C#Core\code\dotnetcore\BasicLessons\Program.cs:line 16
